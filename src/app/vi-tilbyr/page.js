...
const ViTilbyr = () => {
  return (
    <>
        ...
        <p className='p-4 m-4 text-lg lg:w-1/2 md:w-5/6'>Vi vet av erfaring at det er en vanskelig og krevende oppgave å skaffe seg en god bolig for alderdommen. 
        ...
        <div className='m-6 p-4'>
          <Link href='/priser' className='underline'>Klikk her for å se priser på våre tjenester</Link>
