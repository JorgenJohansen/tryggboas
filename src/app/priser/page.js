...
const Priser = () => {
  return (
    <>
        ...
        <h2 className='p-4 font-bold text-xl'>Gratis førstegangsbesøk</h2>
        <p className='p-4 m-4 text-lg lg:w-1/2 md:w-5/6'>I forbindelse med henvendelser, foretar vi gjerne et hjemmebesøk.</p>
        <p className='p-4 m-4 text-lg lg:w-1/2 md:w-5/6'>Hjemmebesøket er gratis, og uforpliktende.
        ...
        <p className='p-4 m-4 text-lg lg:w-1/2 md:w-5/6'>Vi tar også imot kunder på vårt kontor for en samtale angående deres boligsituasjon.</p>

        <h2 className='p-8 font-bold text-xl'>Oppdragsavtale</h2>
        <p className='p-4 m-4 text-lg lg:w-1/2 md:w-5/6'>Oppdragspris er et fast beløp på kr 35 000,-. 
        ...
        <p className='p-4 m-4 text-lg lg:w-1/2 md:w-5/6'>Dersom forhold hos kunden endrer seg eller oppdraget viser seg å være 
